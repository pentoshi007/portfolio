...
export default function Experience() {
  ...
  return (
    <section id="experience" className="py-24 px-4 md:px-8 bg-[#0a0a0f]">
        ...
        <div ref={timelineRef as React.RefObject<HTMLDivElement>} className="relative pl-8 timeline-line">
          {experience.map((exp, index) => (
            <div key={index} className="relative mb-12 last:mb-0">
              ...
              <div className={`hacker-card p-6 transition-all duration-300 ${timelineVisible ? `slide-in-right stagger-${(index % 6) + 1}` : 'opacity-0'}`}>
