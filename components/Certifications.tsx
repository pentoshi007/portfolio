    ...
    <section id="certifications" className="py-16 px-4 md:px-8 bg-transparent">
      <div className="max-w-5xl mx-auto">
        <div
          ...
          className={`mb-10 anim-hidden anim-slide-left ${titleVisible ? "anim-visible" : ""}`}
        >
          ...
          {certifications.map((cert, index) => {
            ...
            return (
              <a
                ...
                className={`hacker-card p-5 group block anim-hidden anim-scale stagger-${(index % 6) + 1} ${gridVisible ? "anim-visible" : ""} ${isLastAndAlone ? "md:col-span-2 md:max-w-[calc(50%-8px)] md:mx-auto md:w-full" : ""}`}
              >
