      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 pb-8 border-b border-[#0fa]/5">
          ...
          <div className="space-y-4 md:text-center">
            <span className="font-mono text-[10px] tracking-widest text-[#0fa] uppercase block">Quick Links</span>
          ...
          <div className="space-y-4 md:text-right">
            <span className="font-mono text-[10px] tracking-widest text-[#0fa] uppercase block">Tech Stack</span>
            <div className="flex md:justify-end items-center gap-3 text-[10px] font-mono text-gray-400">
              <span>Next.js 16</span>
              <span className="text-[#0fa]/30">•</span>
              <span>React 19</span>
              <span className="text-[#0fa]/30">•</span>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 font-mono text-[10px]">
          <div className="text-gray-400 flex items-center gap-2">
            <span className="text-[#0fa]/60">&copy; {new Date().getFullYear()}</span>
