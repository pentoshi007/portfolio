...
interface AdminDashboardProps {
  initialTab?: "messages" | "blogs";
}

export default function AdminDashboard({
  initialTab = "messages",
}: AdminDashboardProps) {
  const [activeTab, setActiveTab] = useState<"messages" | "blogs">(initialTab);
  ...
  const changeTab = (tab: "messages" | "blogs") => {
    setActiveTab(tab);
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        {!msg.read && (
                          <span className="px-2 py-0.5 bg-[#0fa]/20 text-[#0fa] text-xs font-mono">
                            NEW
                          </span>
                        )}
                      </div>
