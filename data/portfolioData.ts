...
export const experience = [
  {
    ...
    location: "Remote",
    highlights: [
      "Developed cyber threat intelligence platform using Node.js and React, integrating VirusTotal and AbuseIPDB APIs for automated IOC enrichment",
      "Built async ingestion pipeline processing 1,000+ malicious indicators daily, reducing manual analysis time by 75%",
      "Implemented RBAC, RESTful API with 20+ endpoints, and multi-format export capabilities using TypeScript",
    ],
  },
  {
    company: "InternPro",
...
export const education = [
  ...
  },
  {
    ...
    location: "New Delhi, India",
    description:
      "Dual degree program with coursework in programming, signal processing, and digital systems.",
  },
];
...
export const projects = [
  ...
  },
  {
    ...
    description:
      "Full-stack CTI platform for tracking, analyzing, and enriching Indicators of Compromise (IOCs).",
    highlights: [
  ...
  },
  {
    ...
    description:
      "Full-stack web app for event discovery, search, and registration with admin tooling.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "Engineered automated cybersecurity education platform delivering daily AI-generated attack analysis.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "AI system for automated medical report generation from X-ray images.",
    highlights: [
...
export const certifications = [
  {
    ...
    link: "https://tryhackme.com/certificate/THM-K2VTBO8L3Y",
  },
  {
